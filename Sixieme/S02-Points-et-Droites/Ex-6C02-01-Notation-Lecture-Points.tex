...
\renewcommand{\centerhead}{Notation des points}
...
\begin{tikzpicture}[scale=1.1]
  ...
  \tkzLabelPoints[below=1.5mm](D,E,F,G)
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[scale=1]
  ...
  \tkzLabelPoints[below=1.5mm](A,B,E)
  \fill (2.4,0) circle (3.5pt);
  \node[below=1.5mm] at (2.4,0) {$c$};
  \fill (7.2,0) circle (3.5pt);
  \node[below=1.5mm] at (7.2,0) {$D$};
  \draw[thick] (12,0) circle (3.5pt);
  \node[below=1.5mm] at (12,0) {$f$};
\end{tikzpicture}
\end{center}
