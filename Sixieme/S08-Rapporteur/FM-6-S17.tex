...
\entete{17}{FM}{Angles et rapporteur}
...
\noindent \textbf{Exemples :} \\ On a représenté l'angle  $\widehat{AOB}$
\begin{center}
...
\end{tikzpicture}
\end{center}
\noindent Le point O est le sommet de l'angle et les demi-droites [OA) et [OB) sont les côtés de l'angle $\widehat{AOB}$.
...
\noindent \textbf{Notation :} Deux angles de même mesure sont codés de la même façon. $\widehat{IHJ}=\widehat{KML}$
...
\end{tikzpicture}
\end{multicols}
\noindent \textbf{Remarque :} Il existe deux angles particuliers : \textbf{L'angle droit} mesure 90° et \textbf{l'angle plat} mesure 180°.


\newpage
\section{Construire un angle}

\noindent \textbf{Énoncé :} Tracer un angle $\widehat{BAC}$ de mesure $137$°.
