...
\begin{exercice}[1][Situation d'équiprobabilité]

Dire si chaque situation est équiprobable.

\begin{enumerate}
    \item Lancer un dé équilibré.
    \item Tirer une carte dans un jeu truqué.
    \item Tirer une boule dans un sac contenant des boules identiques au toucher.
    \item Faire tourner une roue dont certaines parts sont plus grandes.
\end{enumerate}
