...
\draw (A) -- (B) node[midway,below right] {?}; \draw (A) -- (C)
node[midway,below left] {6,1 cm}; \draw (B) -- (C) node[midway,above]
{3,6 cm};
...
\draw (A) -- (B) node[midway,right] {?}; \draw (A) -- (C)
node[midway,below] {147 m}; \draw (B) -- (C) node[midway,above left]
{256 m};
